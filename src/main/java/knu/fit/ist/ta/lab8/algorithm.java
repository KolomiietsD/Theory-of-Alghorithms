...
public class algorithm {
    ...
    public AlgorithmData bubbleSort() {
        int[] array = Arrays.copyOf(_array, _array.length);
        AlgorithmData details = new AlgorithmData();
        int temp = 0;
        int substitutions = 0;
        int comparisons = 0;
    ...
    public AlgorithmData SelecionSort()
    {
        int[] array = Arrays.copyOf(_array, _array.length);
        AlgorithmData details = new AlgorithmData();
        int temp = 0;
    ...
    private void QuickSortInner(int[] array, int low, int high, AlgorithmData details)
    {
    ...
    public AlgorithmData QuickSort()
    {
        int[] array = Arrays.copyOf(_array, _array.length);
        AlgorithmData details = new AlgorithmData();
        long startTime = System.nanoTime();
